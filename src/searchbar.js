...
const SearchBar = ({onSearchChange, onSearchClick, onResetClick, textval})=>{
	return(
		<div className="tc">
	        <input className="input-reset bn black-80 bg-lightest-blue pa2 w-15 br2" onChange={onSearchChange} placeholder="Enter Search Term" value={textval} type="text" name="search" id="search" />
